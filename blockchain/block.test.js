// ============ USING THE JEST LIBRARY FOR TESTING
const hexToBinary = require('hex-to-binary');
// Import the block.js class
const Block = require('./block');
// Import the config.js class
const {GENESIS_DATA, MINE_RATE} = require('../config');
// Import the crypto-hash function
const {cryptoHash} = require('../utilities');

describe('Block', () => {
    // Creating dummy data for the test
    ...
    // Testing the Mine Block function
    describe('mineblock()', () => {
